...
public class FelixGogoTest {
    ...
    public void testCommandLineService() throws Exception {
        ServiceReference[] serviceReferences = bc.getServiceReferences(null,
                "(objectClass=org.knowhowlab.osgi.shell.felixgogo.AbstractFelixCommandsService*)");
        ...
        serviceReferences = bc.getServiceReferences(null,
                "(objectClass=org.knowhowlab.osgi.shell.felixgogo.AbstractFelixCommandsService*)");
    ...
    public void testShellBundleRestart() throws Exception {
        ServiceReference[] serviceReferences = bc.getServiceReferences("org.knowhowlab.osgi.shell.felixgogo.AbstractFelixCommandsService", null);
        int countOfConsoleServices = serviceReferences == null ? 0 : serviceReferences.length;
        ...
        stopBundleAsync(findBundle(bc, "org.knowhowlab.osgi.shell.felix-gogo")).get();
        ...
        startBundleAsync(findBundle(bc, "org.knowhowlab.osgi.shell.felix-gogo")).get();
