...
public class KnopflerfishTest {
    ...
    public void testCommandLineService() throws Exception {
        ServiceReference[] serviceReferences = bc.getServiceReferences("org.knopflerfish.service.console.CommandGroup", null);
        ...
        serviceReferences = bc.getServiceReferences("org.knopflerfish.service.console.CommandGroup", null);
    ...
    public void testShellBundleRestart() throws Exception {
        ...
        stopBundleAsync(findBundle(bc, "org.knowhowlab.osgi.shell.knopflerfish")).get();
        ...
        startBundleAsync(findBundle(bc, "org.knowhowlab.osgi.shell.knopflerfish")).get();
